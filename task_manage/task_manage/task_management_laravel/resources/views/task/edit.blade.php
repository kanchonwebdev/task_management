                            ...
                            <div class="card">
                                <div class="card-body">
                                    <form class="row g-3 needs-validation"
                                        action="{{ route('task.update', $collection->id) }}" method="POST" novalidate>
                                        @csrf
                                        @method('PUT')
                                        <div class="col-md-6">
                                            <label for="title" class="form-label">Task Title</label>
                                            <input type="text" class="form-control" value="{{ $collection->title }}"
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <textarea name="description" class="form-control" id="description" value="{{ $collection->description }}" cols="10"
